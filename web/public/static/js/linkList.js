    ...
    var tableIns = table.render({
        ...
        cols : [[
            ...
            {field: 'logo', title: 'LOGO', width:180, align:"center",templet:function(d){
                if(d.logo){return '<a href="'+d.url+'" target="_blank"><img src="'+d.logo+'" height="26" /></a>';}else{return "";}  
            }},
            ...
            {field: 'typename', title: '所属分类',minWidth:200, align:'center'},
            {title: '排序', align:'center',width:90,templet:function(d){return '<input type="text" style="height:28px" class="layui-input sort" name="order" data-id="'+d.id+'" value="'+d.orders+'">';}},
