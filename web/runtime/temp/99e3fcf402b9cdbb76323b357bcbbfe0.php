<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\wwwroot\thinkphp5_765tm6\web/application/website\view\info\lists.html";i:1538011551;}*/ ?>
<!DOCTYPE html>
<html>
  ...
  <body>
    <div class="x-body">
      <xblock>
          <button class="layui-btn add-btn"><i class="layui-icon layui-icon-add-circle-fine"></i>增加独立信息</button>
    ...
    function addmenu(id,e){
        if(e==1){
          var url="<?php echo url('info/edit','',''); ?>/id/"+id;
          var p="修改";
        }else{
          var url="<?php echo url('info/add','',''); ?>";
          var p="添加";
        }
  ...
  function menu_del(obj,id){
      layer.confirm('确认要删除吗？',function(index){            
          //发异步删除数据
        $.post("<?php echo url('info/del','',''); ?>",{id:id},function(result){
          if(result){
