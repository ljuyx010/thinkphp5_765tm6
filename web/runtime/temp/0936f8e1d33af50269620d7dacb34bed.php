<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wwwroot\thinkphp5_765tm6\web/application/website\view\siteset\wechat.html";i:1537407771;}*/ ?>
<!DOCTYPE html>
	...
	<form class="layui-form">
		<table class="layui-table mag0">
		    ...
		    <tbody>
		    	...
		    	<tr>
		    		<td>key</td>
		    		<td><input type="text" class="layui-input key" <?php if(isset($v['key'])): ?>value="<?php echo $v['key']; ?>"<?php endif; ?> placeholder="Api密匙"></td>
		    		<td pc>微信支付Api密钥</td>
		    	</tr>		    	
