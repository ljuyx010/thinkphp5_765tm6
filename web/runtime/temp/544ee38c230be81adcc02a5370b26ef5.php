<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wwwroot\thinkphp5_765tm6\web/application/website\view\system\menuadd.html";i:1535773868;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
			...
			<div class="layui-col-md9 layui-col-xs7">
				<div class="layui-form-item magt3">
					...
					<div class="layui-input-block">
						<input type="text" class="layui-input newsName" name="name" value="" lay-verify="required" placeholder="请输入菜单名称">
					</div>
				</div>
				<div class="layui-form-item">
					<label class="layui-form-label">菜单图标</label>
					<div class="layui-input-block">
						<input type="text" class="layui-input ico" name="ico" value="" placeholder="请输入菜单图标无图标留空">
					</div>
				</div>
				<div class="layui-form-item">
