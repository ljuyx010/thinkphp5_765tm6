<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:76:"D:\wwwroot\thinkphp5_765tm6\web/application/website\view\banner\typeadd.html";i:1537429763;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	<meta charset="utf-8">
		...
		<div class="layui-row layui-col-space10">
			<div class="layui-col-md9 layui-col-xs7">
				...
				<div class="layui-form-item">
					...
					<div class="layui-input-block">
						<input type="text" style="width:200px;" class="layui-input order" name="order" <?php if(isset($v['orders'])): ?>value="<?php echo $v['orders']; ?>"<?php endif; ?>>
					</div>
				</div>
				<div class="layui-form-item">
				<div class="layui-input-block">
...
layui.use(['form','layer','layedit','laydate','upload'],function(){
    ...
    form.on("submit(addNews)",function(data){
        ...
        // 实际使用时的提交信息
        $.post("<?php echo url('banner/runtype'); ?>",{
            name : $(".name").val(), 
            order : $(".order").val(), 
            id : $('.id').val()
        },function(res){        	
