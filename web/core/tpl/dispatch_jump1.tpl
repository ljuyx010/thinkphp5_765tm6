...
<head>
    ...
    {css href="__STATIC__/jump/msgbox.css" /}
    {css href="__STATIC__/jump/sweetalert.css" /}
    ...
    <div class="system-message">
      <!-- 成功提示 -->
        <?php if($code) {?>
            ...
            </div><div class="sa-icon sa-custom" style="display: none; width: 80px; height: 80px; background-image: url(__STATIC__/jump/thumbs-up.jpg);"></div><h2><?php echo(strip_tags($msg));?></h2>
